...
class PushTEnv(gym.Env):
    ...
    def _setup(self):
       ...
       # Make sure your shapes have collision_type set
        #self.agent.shape.collision_type = 1
        #self.block.shape.collision_type = 2
        #print("self.space:", self.space)
        #print("type:", type(self.space))
        ##print("collision_handeler:", self.collision_handeler)
        #print("space:", getattr(self, "space", None))
        ...
        #try:
        #    self.collision_handeler = self.space.add_default_collision_handeler(0, 0)
        #except AttributeError:
        #    # Older pymunk versions handle collisions differently
